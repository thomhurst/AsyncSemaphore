...
### AsyncSemaphore.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [AsyncSemaphore.Analyzers.Sample.csproj](../AsyncSemaphore.Analyzers.Sample/AsyncSemaphore.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### AsyncSemaphore.Analyzers.Tests
