...
/// <summary>
/// Frozen snapshot of the core as of commit 575a0b2 (a release-state object allocated per acquisition,
/// before the exclusive gate's epoch token of issue #590), kept so <see cref="AbBenchmarks"/> can A/B the
